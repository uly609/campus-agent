...
description: 查询浙江工商大学课程表。用于用户询问课表、某专业某学期课程、某天课程、课程地点、任课教师或课程编号时。
---
...
- `grade`: student grade, such as `2024` or `2024级`
- `class_name`: class name, such as `计科2401班`
- `semester`: semester code, such as `2025-2026-1`
...
- `campus`: campus name, such as `下沙校区`
